//! Error types for mgpm
//!
//! All mgpm errors are defined here, with structured error handling
//! and error reporting support.

use thiserror::Error;

/// Result type alias for mgpm operations.
pub type Result<T> = std::result::Result<T, Error>;

/// Main error type for mgpm
#[derive(Debug, Error)]
pub enum Error {
    // ============ Core Errors ============
    ...
    /// Lockfile outdated
    #[error("lockfile is outdated - run 'mgpm install' to update")]
    LockfileOutdated,
