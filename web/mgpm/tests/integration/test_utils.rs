...
/// A mock project fixture with temp directory, package.json, and mgpm.yaml.
...
impl TestFixture {
    ...
    pub fn mgpm_yaml_path(&self) -> PathBuf {
        self.root.join("mgpm.yaml")
    }
...
/// Creates a temp directory with a mock project (package.json, mgpm.yaml).
...
pub struct MockDependencyProvider {
    packages: HashMap<String, HashMap<String, Vec<mgpm_resolver::ResolvedDependency>>>,
}
...
impl MockDependencyProvider {
    ...
    pub fn add_package(
        ...
        name: &str,
        version: &str,
        deps: Vec<mgpm_resolver::ResolvedDependency>,
    ) {
        self.packages
...
impl mgpm_resolver::DependencyProvider for MockDependencyProvider {
    ...
    fn get_dependencies(&self, package_id: &PackageId) -> Vec<mgpm_resolver::ResolvedDependency> {
        self.packages
