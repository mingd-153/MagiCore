...
use mg_lockfile::lockfile::{LOCKFILE_VERSION, LOCKFILE_VERSION_V1};
use mg_lockfile::pipeline::compute_package_integrity;
use mg_lockfile::text::{read_text, write_text};
