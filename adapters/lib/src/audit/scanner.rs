...
pub(crate) struct CargoAuditParse {
    pub(crate) vulnerabilities: Vec<Vulnerability>,
    pub(crate) packages_audited: usize,
}
...
pub(crate) fn parse_cargo_audit_json(json: &str) -> MgResult<CargoAuditParse> {
...
pub(crate) struct PipAuditParse {
    pub(crate) vulnerabilities: Vec<Vulnerability>,
    pub(crate) packages_audited: usize,
}
...
pub(crate) fn parse_pip_audit_json(json: &str) -> MgResult<PipAuditParse> {
    let json_start = json
        .find('[')
...
fn find_requirements_file(project_root: &Path) -> Option<String> {
...
fn find_pylock_file(project_root: &Path) -> Option<String> {
