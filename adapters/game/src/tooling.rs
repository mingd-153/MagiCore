//! Game tooling helpers for native command passthrough.
//! Gom phần gọi Cargo và placeholder version để adapter chính gọn hơn.
...
pub(crate) fn bevy_dep_version(root: &Path, name: &PackageName) -> Option<Version> {
