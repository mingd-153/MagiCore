...
This project is indexed by GitNexus as **MegaGate** (6497 symbols, 14630 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
