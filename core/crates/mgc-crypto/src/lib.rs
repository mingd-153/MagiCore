//! `mgc-crypto` — Cryptographic primitives for MagiCore supply chain security
//! Cryptographic primitives cho bảo mật chuỗi cung ứng MagiCore
//!
...
pub use blake3_signer::{Blake3Hash, Blake3Hasher};
