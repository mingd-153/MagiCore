...
pub struct LockfileMetadata {
    ...
    /// Generator info (e.g., "mg/1.0.0") — Thông tin generator
...
/// Signature file structure (mg.lock.sig) — Cấu trúc file signature
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
    ...
    pub fn new() -> Self {
        Lockfile {
            ...
            metadata: LockfileMetadata {
                ...
                generator: format!("mg/{}", env!("CARGO_PKG_VERSION")),
...
impl SignatureFile {
    ...
    /// Parse signature file from string — Parse file signature từ chuỗi
    ...
    /// Convert to string format — Chuyển sang định dạng chuỗi
    pub fn to_string(&self) -> String {
        format!(
            "# MegaGate Lockfile Signature v2\n\
             # DO NOT EDIT — Generated by mg trust sign\n\
             lockfile_hash = \"{}\"\n\
             signature = \"{}\"\n\
             key_id = \"{}\"\n\
             signed_at = \"{}\"\n",
