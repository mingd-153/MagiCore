...
```bash
# Download artifact
curl -LO https://github.com/mingd-153/MagiCore/releases/download/v1.1.0-rc.5/magicore-1.1.0-rc.5-macos-arm64.tar.gz

# Verify checksum
curl -LO https://github.com/mingd-153/MagiCore/releases/download/v1.1.0-rc.5/magicore-1.1.0-rc.5-macos-arm64.tar.gz.sha256
shasum -a 256 -c magicore-1.1.0-rc.5-macos-arm64.tar.gz.sha256

# Extract & test
tar -xzf magicore-1.1.0-rc.5-macos-arm64.tar.gz
./mgc --version
```
...
git commit -m "magicore 1.1.0-rc.5"
git push
```
