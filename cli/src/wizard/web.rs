...
impl WebWizard {
    ...
    fn build_tree() -> Question {
        let frontend = Answer::new("Frontend", "frontend").with_questions(vec![
            Question {
        ...
        let backend = Answer::new("Backend", "backend").with_questions(vec![
            Question {
                prompt: "\n  Select language:".to_string(),
                kind: QuestionKind::Select {
                    options: vec![
                        Answer::new("Node.js / TypeScript", "node").with_questions(vec![
                            Question {
                        ...
                        Answer::new("PHP", "php").with_questions(vec![
                            Question {
                                prompt: "\n  Select framework:".to_string(),
                                kind: QuestionKind::Select {
                                    options: vec![
                        ...
                        Answer::new("Java", "java").with_questions(vec![
                            Question {
                                prompt: "\n  Select framework:".to_string(),
                                kind: QuestionKind::Select {
                                    options: vec![
                        ...
                        Answer::new("Go", "go").with_questions(vec![
                            Question {
                                prompt: "\n  Select framework:".to_string(),
                                kind: QuestionKind::Select {
                                    options: vec![
                        ...
                        Answer::new("Python", "python").with_questions(vec![
                            Question {
                                prompt: "\n  Select framework:".to_string(),
                                kind: QuestionKind::Select {
                                    options: vec![
                        ...
                        Answer::new("Rust", "rust").with_questions(vec![
                            Question {
                                prompt: "\n  Select framework:".to_string(),
                                kind: QuestionKind::Select {
                                    options: vec![
        ...
        let fullstack = Answer::new("Fullstack", "fullstack").with_questions(vec![
            Question {
