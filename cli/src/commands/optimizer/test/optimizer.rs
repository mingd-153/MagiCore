//! Unit tests for MegaGate Optimizer Engine
...
fn test_hash_guard_prevents_overwriting_user_custom_file() {
    ...
    let opt_file = OptimizedConfigFile {
        relative_path: ".mg-optimizer/test.env".to_string(),
        content: "# Generated by MegaGate Optimizer\nKEY=VALUE\n".to_string(),
    ...
    let file_path = root.join(".mg-optimizer/test.env");
    ...
    assert!(content_after.contains("Generated by MegaGate Optimizer"));
}
